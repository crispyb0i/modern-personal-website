...
// I will implement a simpler version without cva for now to avoid extra dependencies if not needed, 
// or I can just install it. 
// Actually, for a personal site, I can just write standard tailwind classes. 
// Let's stick to a simple implementation first.
